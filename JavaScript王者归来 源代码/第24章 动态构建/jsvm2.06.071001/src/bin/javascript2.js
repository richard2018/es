 ...
 * |2007-10-09 fixed Exception creating.
 * @Latest modified: 2007.10.09*/

_JSVM_Namespace.runtimeEnvironment.loadModule("javascript2", function()
...
Class.prototype.$implements = function()
{
	for(var i = 0; i < arguments.length; i++)
	{
		...
		{
			throw new Exception("Class.$implements(type...) fail.", ex);
		}
	}
...
Class.prototype.$extends = function(clz)
{
	try
	{
		...
		{
			throw new Exception("class.$extends(Class) error:"
	...
	{
		throw new Exception("class.$extends(Class) fail.", ex);
	}
}
