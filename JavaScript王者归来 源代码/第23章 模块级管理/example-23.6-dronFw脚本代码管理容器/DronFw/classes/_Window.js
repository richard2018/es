...
DronFw.Class.Window = function ()
{
	...
	this.Title = "未命名标题";
	this.Content = "&nbsp;";
	this.Ico = DronFw.Path + "classes/_Window/ico.gif";
	this.MinButton = true;
	this.MaxButton = true;
	this.CloButton = true;
	//系统属性
	...
	this.Show = function ()
	{
		var s = "<table width=\"100%\" height=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"window_table\">\
			<tr bgcolor=\"#08246b\">\
				<td width=\"18\" height=\"18\" align=\"center\"><img src=\"" + this.Ico + "\" class=\"window_ico\"></td>\
...
(
	function ()
	{
		...
		link.rel = "stylesheet";
		link.href = DronFw.Path + "classes/_Window/win.css";
		link.type = "text/css";
		link.media = "all";
